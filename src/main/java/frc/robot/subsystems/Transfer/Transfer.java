...
public class Transfer extends SubsystemBase {
    ...
    private LoggedNetworkNumber floorRollerIdleVoltage = new LoggedNetworkNumber("Rebuilt/Transfer/FloorRoller/IdleVoltage", 10);
    private LoggedNetworkNumber floorRollerRunVoltage = new LoggedNetworkNumber("Rebuilt/Transfer/FloorRoller/RunVoltage", 50);
    ...
    private LoggedNetworkNumber sideSweepIdleVoltage = new LoggedNetworkNumber("Rebuilt/Transfer/SideSweep/IdleVoltage", 10);
    private LoggedNetworkNumber sideSweepRunVoltage = new LoggedNetworkNumber("Rebuilt/Transfer/SideSweep/RunVoltage", 50);
    private LoggedNetworkNumber cornerSweepIdleVoltage = new LoggedNetworkNumber("Rebuilt/Transfer/CornerSweep/IdleVoltage", 10);
    private LoggedNetworkNumber cornerSweepRunVoltage = new LoggedNetworkNumber("Rebuilt/Transfer/CornerSweep/RunVoltage", 50);
    private LoggedNetworkNumber turretTransferIdleVoltage = new LoggedNetworkNumber("Rebuilt/Transfer/TurretTransfer/IdleVoltage", 10);
    private LoggedNetworkNumber turretTransferRunVoltage = new LoggedNetworkNumber("Rebuilt/Transfer/TurretTransfer/RunVoltage", 50);
    ...
    private void applyState() {
        ...
        sideSweep.setControl(sideSweepVoltageRequest);
